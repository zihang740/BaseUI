...
public class StatusBarUtil {
    ...
    public static void init(Activity activity){
        //主题色调 | true:深色 false:浅色
        StatusBarUtil.setTransparentForImageView(activity, null);
        if(BaseInitData.base_theme_Tone){
            StatusBarUtil.setWhileIconToImage(activity);
        } else {
            StatusBarUtil.setBlackIconToImage(activity);
        }
    }
    ...
    public static void setTranslucentForImageView(Activity activity, View needOffsetView) {
        setTranslucentForImageView(activity, needOffsetView);
    }
